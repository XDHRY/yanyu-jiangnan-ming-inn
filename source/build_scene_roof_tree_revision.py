...
lathe('upper_veranda_lotus_pot',(8.80,8.80,2.82),[(0,0),(.03,.15),(.28,.23),(.34,.24),(.34,.18),(.08,.11)],'red',16)
for dx,dy,dz in [(-.14,0,.48),(.02,.04,.58),(.16,-.02,.46),(.04,-.12,.68)]:
 sphere('upper_veranda_lotus_leaf',(8.80+dx,8.80+dy,3.16+dz),(.13,.10,.18),'leaf',1)
