...
This script has not been executed here: native Blender is unavailable.
"""
...
bpy.ops.import_scene.gltf(filepath=str(P/'ming_review.glb'))
...
for mat in bpy.data.materials:
 ...
 bump=nodes.new('ShaderNodeBump');bump.inputs['Strength'].default_value=.22;bump.inputs['Distance'].default_value=.0006;links.new(noise.outputs['Fac'],bump.inputs['Height']);links.new(bump.outputs['Normal'],p.inputs['Normal'])
...
bpy.ops.wm.save_as_mainfile(filepath=str(P/'jiangnan_inn_ming.blend'))
